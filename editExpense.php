...
<body>
    ...
    <div class="body">
    <div class="signup">
    <h1 class="signup-heading">Search Expense</h1>
        ...
        <pre></pre>
        <form action="editExpense.php" class="signup-form" method="post" autocomplete="off">
          ...
          <pre></pre>
          <button class="signup-submit" name="submit"><a href="">Search</a></button>
        </form>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $expense_model->searchExpenses($keyword);
}
?>>